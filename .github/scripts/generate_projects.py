...
Theme: matches the profile banner (navy #0A101F, cyan #22D3EE, cyan #06B6D4,
mono font, dotted leaders, pulsing dots, animated accents).
"""
...
THEMES = {
    "dark": {
        ...
        "CYAN": "#22D3EE", "VIOLET": "#06B6D4", "VIOLET2": "#0891B2",
        "EMERALD": "#06B6D4", "TEXT": "#F8FAFC", "MUTED": "#94A3B8",
        "DIM": "#475569",
        "STROKE": "rgba(34,211,238,0.28)", "STROKE_HI": "rgba(34,211,238,0.5)",
        "STROKE_LO": "rgba(34,211,238,0.22)", "BARLINE": "rgba(255,255,255,0.08)",
        "RING_BG": "rgba(148,163,184,0.15)", "PILL_BG": "rgba(6,182,212,0.28)",
        "PILL_STROKE": "rgba(34,211,238,0.5)", "MONO_TX": "#CFFAFE",
    },
    "light": {
        "BG": "#F8FAFC", "PANEL": "#FFFFFF", "PANEL_BAR": "#F1F5F9",
        "CYAN": "#0891B2", "VIOLET": "#06B6D4", "VIOLET2": "#0E7490",
        "EMERALD": "#0891B2", "TEXT": "#0F172A", "MUTED": "#475569",
        "DIM": "#94A3B8",
        "STROKE": "rgba(8,145,178,0.30)", "STROKE_HI": "rgba(8,145,178,0.55)",
        "STROKE_LO": "rgba(8,145,178,0.20)", "BARLINE": "rgba(0,0,0,0.08)",
        "RING_BG": "rgba(100,116,139,0.20)", "PILL_BG": "rgba(8,145,178,0.12)",
        "PILL_STROKE": "rgba(8,145,178,0.4)", "MONO_TX": "#FFFFFF",
